        ...
        <table class="table">
            ...
            <tbody>
                @foreach ($produits as $produit)
                    <tr>
                        <td><img src="{{ $produit->image }}" alt="{{ $produit->designation }}"
                                style="max-width: 100px;"></td>
                        <td>{{ $produit->designation }}</td>
                        <td>{{ $produit->prix_unitaire }}</td>
                        <td>
                            <a href="/modificationProduit/{{ $produit->id }}" class="btn btn-primary btn-sm"><i
                                    class="fas fa-edit"></i> Modifier</a>
                            <a href="/detailsProduit/{{ $produit->id }}" class="btn btn-primary btn-sm"><i
